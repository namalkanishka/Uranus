...
export default class App extends Component {
  state = {
    inputValue1: "First Name",
    inputValue: "Last Name",
    inputValue2: "MObile Number"
  ...
  render() {
    return (
        ...
        <Text style={styles.yellow}>First Name</Text>
        ...
        />
      <Text style={styles.yellow}>Last Name</Text>
        <TextInput
        ...
        <Text style={styles.yellow}>Mobile Number</Text>
        <TextInput
